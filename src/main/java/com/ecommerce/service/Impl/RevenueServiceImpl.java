...
public class RevenueServiceImpl implements RevenueService {
    ...
    // Get daily revenue data foa the past X days


    @Override
    public List<RevenueChart> getDailyRevenueForChart(int days, Long sellerId) {
        List<RevenueChart> revenueDate = new ArrayList<>();
        ...
        for (int i = days -1; i >= 0; i--) {
            ...
            double dailyRevenue = orderRepository.findBySellerIdAndOrderDateBetween(sellerId,date.atStartOfDay(),date.plusDays(1).atStartOfDay())
